...
|---|---|---|
| `013a/b/c` membresías/RLS v2 | **Aplicadas** (verificado 2026-09-05: tablas, las tres funciones `auth_*_ids()`, triggers `athletes_seed_membership` y `sessions_authorship_guard`, y `013c` con `sessions.authored_by_role NOT NULL`) | Precondición de `030` satisfecha. Falta el inventario de `pg_policies` (Paso 0 del runbook 1a) antes de aplicar `030` |
