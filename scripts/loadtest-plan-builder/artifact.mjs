...
export function toWeekRow(week, context) {
  ...
  return {
    ...
    squashDrillRotationActionCount: meta.squashDrillRotationActionCount ?? null,
    squashDrillRotationSessionsAffected: meta.squashDrillRotationSessionsAffected ?? null,
    squashDrillRotationOmittedCount: meta.squashDrillRotationOmittedCount ?? null,
    squashSignatureUniquenessFailureAttemptCount: context.squashSignatureUniquenessFailureAttemptCount ?? null,
    squashSessionCount: context.squashSessionCount ?? null,
    squashDrillUseCount: context.squashDrillUseCount ?? null,
    squashUniqueDrillCount: context.squashUniqueDrillCount ?? null,
    squashDrillVarietyRatio: context.squashDrillVarietyRatio ?? null,
    squashTopDrillUseCount: context.squashTopDrillUseCount ?? null,
    squashTopSessionRatio: context.squashTopSessionRatio ?? null,
