...
export default function CoachMessageCard({ message }: CoachMessageCardProps) {
  ...
  return (
    <button
      ...
      className="w-full text-left bg-brand/10 border border-brand/25 rounded-card p-4 flex gap-3 items-start hover:bg-brand/15 transition-colors active:scale-[0.98]"
    >
