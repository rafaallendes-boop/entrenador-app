...
export const REMOTE_ATHLETE_ACK_KEY_PREFIX = 'entrenador_remote_athlete_ack_v1'
...
export function getRemoteAthleteAckKey(userId: string): string {
  return `${REMOTE_ATHLETE_ACK_KEY_PREFIX}:${userId}`
}
