...
- Respeta la cantidad y el deporte pedidos. Pesas/fuerza con foco en recuperación sigue siendo strength, con ejercicios y dosis adaptados a las restricciones; si no puedes hacerlo de forma segura, explica el impedimento sin sustituirlo silenciosamente por movilidad.
- Toda sesión mobility/recovery debe incluir ejercicios con dosis en mobilityDetails.targetStructure o exercises. Warmup y cooldown solos no constituyen una sesión.
...
5. Si no hay sesiones en la semana → crea una semana base COMPLETA solo si el usuario pidió una semana; una sesión puntual sigue siendo una sola sesión.
...
4. Si la semana está vacía, crea una semana completa solo si la pidió; un pedido puntual sigue siendo una sesión.
