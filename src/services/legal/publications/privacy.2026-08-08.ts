 ...
 */
export const PRIVACY_2026_08_08: LegalDocumentContent = {
    ...
    { kind: 'heading', text: 'Datos que tratamos' },
    {
      ...
      items: [
        ...
        [
          ...
          {
            text: ' si conectas Whoop, usamos recovery, HRV, frecuencia cardiaca en reposo, strain, datos de sueño y los entrenamientos que Whoop detecta —fecha, deporte, duración, frecuencia cardiaca media y máxima, distancia cuando corresponde, la distribución del tiempo entre las seis zonas de frecuencia cardiaca de Whoop, y el porcentaje de la sesión en que Whoop registró frecuencia cardiaca—. La conexión es ',
          },
