...
export const SQUASH_DRILL_LIBRARY: SquashDrillDefinition[] = [
  ...
  {
    id: 'back_court_pressure_same_wall',
    name: 'Presión de fondo',
    category: 'tactical',
    focus: ['conditioned_game', 'pressure', 'back_court'],
    intensity: 'high',
    tags: ['conditioned_game', 'pressure', 'back_court', 'length', 'build', 'peak'],
    description: 'Jugador A alimenta todo el pasillo y jugador B solo puede responder al fondo del mismo lado, sosteniendo profundidad bajo presión continua.',
    intent: 'pressure',
    constraints: [
      'Jugador B solo puede jugar al fondo donde se encuentra jugador A',
      'Priorizar longitud y recuperacion rapida al T en cada intercambio',
    ],
    progressionLevel: 3,
  },
  {
    id: 'three_quarter_court_pressure',
    name: 'Presión a 3/4 de cancha',
    category: 'tactical',
    focus: ['conditioned_game', 'pressure', 'transition'],
    intensity: 'high',
    tags: ['conditioned_game', 'pressure', 'back_court', 'transition', 'build', 'peak'],
    description: 'Jugador A alimenta todo el pasillo y puede usar doble pared a la esquina contraria; jugador B responde solo al fondo del lado de A en un patrón de muy alta exigencia.',
    intent: 'pressure',
    constraints: [
      'Jugador A puede incluir doble pared hacia la esquina contraria para cambiar el patron',
      'Jugador B mantiene solo fondo al lado donde esta A, sin salir del objetivo tactico',
    ],
    progressionLevel: 3,
  },
  {
