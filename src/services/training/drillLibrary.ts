...
const RAW_SQUASH_DRILL_LIBRARY: SquashDrillDefinition[] = [
  {
    ...
    description: 'Golpea paralelo desde el fondo hacia la esquina profunda del mismo lado. Objetivo: que la pelota viaje larga, pegada a la pared lateral y obligue al rival a golpear desde atrás. Clave: no busques potencia; busca altura, largo y repetir el mismo contacto.',
    intent: 'consistency',
  ...
  },
  {
    ...
    description: 'Golpea cruzado hacia la esquina profunda contraria. Objetivo: cambiar de lado sin regalar una pelota corta en media cancha. Clave: apunta alto en la pared frontal y termina el golpe hacia la esquina de fondo, no hacia el centro.',
    intent: 'control',
    progressionLevel: 1,
  },
  {
    ...
    description: 'Alterna una paralela y una cruzada desde el fondo o media cancha. Objetivo: cambiar dirección manteniendo profundidad y control de la T. Clave: prepara igual ambos golpes para que el rival no lea demasiado pronto hacia dónde vas a jugar.',
    progressionLevel: 2,
  },
  {
    ...
    description: 'Juega un boast hacia el frente y después sal con un drive paralelo profundo. Objetivo: practicar cómo salir del rincón sin quedar atrapado. Clave: después del boast, recupera rápido a la T y juega la paralela con largo antes de pensar en atacar.',
    progressionLevel: 2,
  },
  {
    ...
    description: 'Desde la zona delantera, juega un drop corto y responde con otro drop del mismo lado o cruzado. Objetivo: mejorar toque, control de altura y paciencia cerca de la pared frontal. Clave: mano suave, pelota baja y segundo bote antes del cuadro de saque.',
    progressionLevel: 1,
  },
  {
    id: 'solo_100_drops',
    ...
    description: 'Sin rival: completa 100 drops desde la zona delantera, 50 por lado. Objetivo: construir sensación de mano y control fino sin fatiga alta. Clave: cuenta solo los drops que quedan bajos y mueren antes del cuadro de saque; si empiezas a apurar el brazo, baja el ritmo.',
    intent: 'control',
  ...
  },
  {
    ...
    description: 'Desde media cancha, juega drops hacia la esquina delantera del mismo lado. Objetivo: convertir una pelota cómoda en presión al frente sin avisar. Clave: misma preparación que un drive, menos velocidad al impacto y pelota baja después del bote.',
    intent: 'control',
  ...
  },
  {
    ...
    description: 'Volea sin dejar botar la pelota, manteniéndola frente a ti y por encima de la chapa. Objetivo: ganar timing y confianza tomando la pelota temprano. Clave: contactos limpios, cortos y controlados; no conviertas el ejercicio en pegar fuerte.',
    intent: 'control',
  ...
  },
  {
    ...
    description: 'Desde la T, espera una pelota cómoda en media cancha y atácala hacia una esquina o con un drop claro. Objetivo: reconocer cuándo la pelota sí merece ataque. Clave: ataca equilibrado y temprano; si llegas forzado, juega profundo y reconstruye el punto.',
    progressionLevel: 3,
  },
  {
  ...
  },
  {
    ...
    description: 'Cada punto empieza con un boast hacia el frente. Objetivo: practicar cómo resolver una pelota que abre la cancha y después ordenar el punto. Clave: no admires el boast; sal, recupera a la T y prepárate para la respuesta corta o cruzada.',
    progressionLevel: 2,
  },
  {
  ...
  },
  {
    ...
    description: 'Muévete desde la T hacia las cuatro esquinas sin pelota, simulando un golpe real en cada llegada. Objetivo: grabar rutas limpias de movimiento sin depender de la pelota. Clave: llega equilibrado, golpea imaginario y vuelve a la T con el mismo ritmo.',
    intent: 'consistency',
  ...
  },
  {
    ...
    description: 'Muévete sin pelota desde la T hacia seis zonas: frente, media cancha y fondo por ambos lados. Objetivo: mejorar cobertura completa y cambios de dirección. Clave: rápido no significa desordenado; mantén postura baja y vuelve al centro en cada repetición.',
    progressionLevel: 2,
  },
  {
    ...
    description: 'Haz un split-step corto, sal hacia la esquina indicada y vuelve a la T. Objetivo: entrenar el primer paso después de leer la dirección. Clave: el split-step es pequeño y reactivo; no saltes alto ni te quedes clavado después del golpe simulado.',
    intent: 'recovery',
    progressionLevel: 1,
  },
  {
    ...
    description: 'Haz bloques de 10 a 15 segundos moviéndote explosivo entre la T y las esquinas. Objetivo: repetir esfuerzos cortos como en rallies exigentes. Clave: si la técnica se rompe, corta el bloque; la calidad de pies importa más que sufrir por sufrir.',
    progressionLevel: 3,
  },
  {
  ...
  },
  {
    ...
    description: 'Desde una posición incómoda, juega un lob alto hacia el fondo para ganar tiempo. Objetivo: salir de defensa sin regalar una pelota fácil. Clave: altura primero, profundidad después; vuelve a la T antes de que el rival golpee.',
    intent: 'recovery',
  ...
  },
  {
    ...
    description: 'Desde media cancha o el frente, juega un lob alto hacia el fondo cuando el rival espera una pelota rápida. Objetivo: cambiar ritmo y sacarlo de la T. Clave: usa la misma preparación que para una pelota corta y prepárate para atacar la respuesta.',
    intent: 'control',
  ...
  },
  {
    ...
    description: 'Desde media cancha, juega un boast para que la pelota llegue baja al frente. Objetivo: abrir la cancha y obligar al rival a correr hacia adelante. Clave: después del golpe avanza; la ventaja está en tomar temprano la siguiente pelota.',
    intent: 'pressure',
  ...
  },
  {
    ...
    description: 'Desde el fondo, juega un boast con intención ofensiva para llevar la pelota al frente. Objetivo: cambiar una defensa larga en una oportunidad de ataque. Clave: úsalo solo si llegas con espacio suficiente; si estás muy tarde, mejor lob alto y recupera.',
    intent: 'pressure',
  ...
  },
  {
    ...
    description: 'Muévete continuo desde la T hacia distintas zonas de la cancha sin acelerar al máximo. Objetivo: construir base aeróbica específica de squash sin convertirlo en sprint. Clave: respiración estable, postura limpia y vuelta a la T en cada movimiento.',
    intent: 'consistency',
  ...
  },
  {
    ...
    description: 'Juega un game a 11 puntos con diferencia de 2, marcador real y servicio como en competencia. Objetivo: sentir presión real en formato corto. Clave: usa rutina entre puntos, juega el primer tiro con intención y observa cómo cierras cuando el marcador pesa.',
    progressionLevel: 3,
  },
  {
