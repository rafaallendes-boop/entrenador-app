...
const FROZEN_KNOWN_IDS = [
  ...
  'ladder_lateral_crossover',
  'ladder_lateral_icky_shuffle',
  'ladder_split_step_acceleration',
  'landmine_press',
  'lat_pulldown',
  'lateral_band_walk',
  ...
  'med_ball_slam',
  'mini_hurdle_lateral_rebounds',
  'mini_hurdle_single_leg_lateral_hops',
  'mixed_grip_pull_up',
  'overhead_press',
  'pallof_press',
  'plank',
