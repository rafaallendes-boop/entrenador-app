...
Ver `PROJECT_REVIEW_AND_ROADMAP.md` para el estado completo. Actualizado: 2026-07-31.
Suite: 324 archivos / 2425 tests. `npm test`, lint y build OK.
...
- **Conversaciones del chat** (2026-07-26): índice derivado de `chatMessages` con scope estricto por atleta, sin migraciones; drawer para listar, buscar, retomar y borrar, con scroll al mensaje encontrado; rotación por día calendario y continuidad explícita de hilos antiguos. La derivación escanea todos los mensajes de la cuenta porque Dexie v18 no tiene índice compuesto `[athleteId+timestamp]`; se mantiene así hasta que el volumen justifique medir y migrar. **Verificado localmente; pendiente smoke en dev (`docs/superpowers/smokes/2026-07-26-chat-conversations-dev-smoke.md`), commit y deploy.**
